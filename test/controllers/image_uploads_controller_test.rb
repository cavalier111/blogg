...
class ImageUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_upload" do
    assert_difference('ImageUpload.count') do
      post image_uploads_url, params: { image_upload: { description: @image_upload.description, image: @image_upload.image, title: @image_upload.title } }
    end
  ...
  test "should update image_upload" do
    patch image_upload_url(@image_upload), params: { image_upload: { description: @image_upload.description, image: @image_upload.image, title: @image_upload.title } }
